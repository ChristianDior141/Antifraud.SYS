...
| 8 | Нет прав субъекта данных (DSAR) | Высокий | GDPR Art.15–20 | ⏳ Stage 2 |
| 9 | Учёт согласий без версии/времени/отзыва | Средний | GDPR Art.7 | ⏳ Stage 2 |
| 10 | Нет политики хранения/ретеншена | Средний | GDPR Art.5(1)(e) | ⏳ Stage 2 |
| 11 | Нет аудита просмотра PII | Высокий | GDPR Art.30 / A.12.4 | ⏳ Stage 2 |
...
| 14 | Логи аудита изменяемы | Средний | A.12.4.2 | ⏳ Stage 2 |
...
### Этап 2 — GDPR Compliance
- DSAR (доступ/экспорт/удаление/ограничение/исправление), журнал согласий, политика хранения + purge, аудит доступа к PII, hash-chain логов, реестр PII.
